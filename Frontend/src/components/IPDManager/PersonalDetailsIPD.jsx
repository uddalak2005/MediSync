...
import FormTextInput from "../CommonComponents/FormTextInputs.jsx";
...
const PersonalDetails = ({ nextPage }) => {
    ...
    const selectedBed = JSON.parse(localStorage.getItem('selectedBed'));
    ...
    return(
        <div className='formArea'>
            <div style={{padding:'10px', overflowY: 'auto', height: '70vh'}}>
                <p style={{fontSize: '20px', fontWeight: '600', padding: '15px'}}>Admission Details</p>
                <div className="rows">
                    {<div className="info">
                        <input
                            name="date"
                    ...
                    <div className="info">
                        ...
                        <input type="number"
                               ...
                               onChange={handleChange}
                               placeholder="Enter the Bed Number Shown Above"
                               className="formTextInput"/>
                    </div>
                </div>
